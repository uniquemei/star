package com.fly.jiejing.pickerlib;
...
import com.fly.jiejing.pickerlib.base.BaseLayout;
import com.fly.jiejing.pickerlib.scroll.ScrollableView;
import com.fly.jiejing.pickerlib.util.TextUtil;
import com.fly.jiejing.pickerlib.wheel.WheelView;
import com.fly.jiejing.pickerlib.wheel.adapter.ArrayWheelAdapter;
import com.fly.jiejing.pickerlib.wheel.adapter.NumberWheelAdapter;
import com.fly.jiejing.pickerlib.wheel.adapter.WheelAdapter;
...
public class TimePicker extends BaseLayout {
    ...
    private void buildAdapters() {
        mAdapterDate = new ArrayWheelAdapter(TextUtil.getStringArray(R.array.time_picker_date));//显示今天明天后天
        mAdapterHour = new NumberWheelAdapter(0, 24, 1, "点");
        mAdapterMinute = new NumberWheelAdapter(0, 60, 20, "分");
    }
