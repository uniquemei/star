package com.fly.jiejing.pickerlib.util;
...
public class WindowUtil {
    /** UI设计的竖向高度,单位：px */
    private static final int UI_DESIGN_PORTRAIT_SIZE = 1280;
    //getWindowManager().getDefaultDisplay().getHeight();      // 屏幕高（像素，如：800p）
    /** UI设计的横向高度,单位：px */
    private static final int UI_DESIGN_LANDSCAPE_SIZE = 720;
   //getWindowManager().getDefaultDisplay().getWidth();
    ...
    public static boolean setWidth(View view, int designedWidthResId) {
        float designedWidth =MainApplication.getContext().getResources().getDimension(designedWidthResId);
    ...
    public static boolean setHeight(View view, int designedHeightResId) {
        if (view == null)
            return false;
        float designedHeight = MainApplication.getContext().getResources().getDimension(designedHeightResId);
        LayoutParams params = null;
        if (view instanceof ViewGroup)
            params = view.getLayoutParams();
        if (params == null)
    ...
    public static boolean setTextSize(TextView view, int designedTextSizeResId) {
        if (view == null)
            return false;
        float designedSize =MainApplication.getContext().getResources().getDimension(designedTextSizeResId);
    ...
    public static float getHorizontalScaledDimen(int heightResId) {
        return MainApplication.getContext().getResources().getDimension(heightResId) * SCALE_RATIO_HORIZONTAL;
    }
    ...
    public static float getVerticalScaledDimen(int heightResId) {
        return MainApplication.getContext().getResources().getDimension(heightResId) * SCALE_RATIO_VERTICAL;
    }
    ...
    public static float computeDimen(int resId) {
        return MainApplication.getContext().getResources().getDimension(resId);
    }
    ...
    public static boolean isLandscape() {
        return MainApplication.getContext().getResources().getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE;
    }
    ...
    public static int dip2px(float dip) {
        float f = MainApplication.getContext().getResources().getDisplayMetrics().density;
