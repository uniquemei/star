...
public class TextUtil {
    ...
    public static String getString(int resId) {
        return MainApplication.getContext().getResources().getString(resId);
    }
    ...
    public static String getString(int resId, Object... formatArgs) {
        return MainApplication.getContext().getResources().getString(resId, formatArgs);
    }
...
//    }
    ...
    public static String[] getStringArray(int arrayResId) {
        return MainApplication.getContext().getResources().getStringArray(arrayResId);
    }
}
