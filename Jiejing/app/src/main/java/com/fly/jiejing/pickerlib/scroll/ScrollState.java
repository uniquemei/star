package com.fly.jiejing.pickerlib.scroll;
...
public class ScrollState {
    ...
    public ScrollState() {
        mScroller = new Scroller(MainApplication.getContext());
    }

    public ScrollState(Interpolator interpolator) {
        mScroller = new Scroller(MainApplication.getContext(), interpolator);
    }
